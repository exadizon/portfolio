...
<template>
  <div class="w-full min-h-screen flex flex-col px-4 sm:px-6 md:px-8">
    ...
    <!-- Fixed Footer -->
    <div class="bottom-0 left-0 w-full py-6 flex justify-center items-center z-50 pointer-events-none">
      <div class="flex gap-6 sm:gap-8 md:gap-10 text-sm sm:text-base tracking-tight pointer-events-auto text-black lowercase font-bold">
